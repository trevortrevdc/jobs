...
const Midsection = () => (
	<div>
		...
		<section className="section">
			<div className="container">
				<p className="title is-2 has-text-weight-bold">Attend one of our Hiring Events</p>
				...
				<div className="columns is-multiline">
					<div className="column is-half video-responsive">
						<div className="video-responsive">
							<iframe width="100%" height="100%" src="https://www.youtube.com/embed/i_Y0Uhog-bE" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
						</div>
					</div>
					<div className="column is-half">
						<div className="video-responsive">
							<iframe width="100%" height="100%" src="https://www.youtube.com/embed/w1oDlCCwOgM" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
						</div>
					</div>
				</div>
			</div>
